...
**Project:** FFC_Single_Page_Template -- a Free For Charity website for
...
The site deploys to both `` and `https://freeforcharity.github.io/FFC_Single_Page_Template/`. The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
